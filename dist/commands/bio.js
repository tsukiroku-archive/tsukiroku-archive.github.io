...
<br>
  ...
  <div class="bio-content">
    ...
    <span>
      ...
      <div>
        <br>
        ${color("트위터", "2aa9e0")}: <a href="https://twitter.com/tsukiroku_t">${color("@tsukiroku_t", "2aa9e0")}</a>
        <br>
        ${color("깃허브", "9cdaf0")}: <a href="https://github.com/tsukiroku">${color("@tsukiroku", "2aa9e0")}</a>
    </div>
    <br>
...
<div class="bio-content">
  ...
  <span>
    ...
    <div>
      <br>
      ${color("Twitter", "2aa9e0")}: <a href="https://twitter.com/tsukiroku_t">${color("@tsukiroku_t", "2aa9e0")}</a>
      <br>
      ${color("Github", "9cdaf0")}: <a href="https://github.com/tsukiroku">${color("@tsukiroku", "2aa9e0")}</a>
    </div>
    <br>
    <div style="font-size: 1.5rem">
        <br>
